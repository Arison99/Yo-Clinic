...
function Copyright(props) {
    return (
        <Typography variant="body2" color="text.secondary" align="center" {...props}>
            {'Developed with 🖤 by '}
            <strong><a className='text-style' href="#" target="_blank" rel="noreferrer noopener">B-Arison & Moses</a> </strong>{'Copyright ©'}
...
const Footer = () => {
    return (
        <footer>
            <Box className='sticky-container' sx={{ bgcolor: '#ADD8E6', color: 'text.secondary', mt:3 , pb: 2, top: 'auto' }}>
                        ...
                        <Grid sx={{ m: 'auto' }} item xs={12} sm={6} md={4}>
                            ...
                            <Stack direction="row"
                                ...
                                <Avatar sx={{ mt: 1, bgcolor: pink[500] }}>
                                    <LocationOnIcon />
                                </Avatar><span>Kampala ,Uganda</span>
                            </Stack >
                            ...
                            <Stack direction="row"
                                ...
                                <a className='text-style' href="mailto:harrisondaviinci@gmail.com">
